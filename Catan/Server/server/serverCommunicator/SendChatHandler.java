...
public class SendChatHandler implements HttpHandler {
	...
	public SendChatHandler(ITranslator translator, IMovesFacade movesFacade, IMovesCommandLog movesLog) {
	...
	public void handle(HttpExchange exchange) throws IOException {
		...
		if(exchange.getRequestMethod().toLowerCase().equals("post")) {
			try { 
				...
				movesLog.store(new SendChatCommand(movesFacade, request, cookie));
