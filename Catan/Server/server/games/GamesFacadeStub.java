		...
		*/
		...
		try {
			...
			try {
				...
				serverModel.getPlayers().get(0).getOldDevCards().setRoadBuilding(1);
				serverModel.getPlayers().get(0).getOldDevCards().setMonument(1);
				serverModel.getPlayers().get(0).getOldDevCards().setMonopoly(1);
				serverModel.getPlayers().get(0).getOldDevCards().setSoldier(3);
				serverModel.getPlayers().get(0).getOldDevCards().setYearOfPlenty(1);
				...
				serverModel.getPlayers().get(1).getOldDevCards().setMonument(1);
				serverModel.getPlayers().get(1).getOldDevCards().setMonopoly(1);
				serverModel.getPlayers().get(1).getOldDevCards().setSoldier(4);
				serverModel.getPlayers().get(1).getOldDevCards().setYearOfPlenty(1);
				serverModel.getPlayers().get(1).getOldDevCards().setRoadBuilding(1);
				...
				serverModel.getPlayers().get(2).getOldDevCards().setMonument(1);
				serverModel.getPlayers().get(2).getOldDevCards().setMonopoly(1);
				serverModel.getPlayers().get(2).getOldDevCards().setSoldier(1);
				serverModel.getPlayers().get(2).getOldDevCards().setYearOfPlenty(1);
				serverModel.getPlayers().get(2).getOldDevCards().setRoadBuilding(1);
				...
				serverModel.getPlayers().get(3).getOldDevCards().setMonument(1);
				serverModel.getPlayers().get(3).getOldDevCards().setMonopoly(1);
				serverModel.getPlayers().get(3).getOldDevCards().setSoldier(1);
				serverModel.getPlayers().get(3).getOldDevCards().setYearOfPlenty(1);
				serverModel.getPlayers().get(3).getOldDevCards().setRoadBuilding(1);
